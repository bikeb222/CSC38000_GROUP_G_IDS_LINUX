...
At least three custom alerts should be demonstrated for the final report. If a live WSL interface does not capture one test, document the limitation and use PCAP mode as supporting evidence.
